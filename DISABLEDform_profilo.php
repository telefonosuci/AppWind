<?php 
	 ...
	 */
	$eloqua_firstname = $_POST['fos_user_profile_form[firstName]'];
	$eloqua_lastname = $_POST['fos_user_profile_form[lastName]'];
	$eloqua_emailaddress = $_POST['fos_user_profile_form[email]'];
	$eloqua_businessphone = $_POST['fos_user_profile_form[userInfo][phone]'];
	$eloqua_company = $_POST['fos_user_profile_form[userInfo][companyName]'];
	$eloqua_companysize = $_POST['fos_user_profile_form[userInfo][companySize]'];
